...
- Name: claimValidation.spec.ts >> Healthcare Pharmacy Claim Adjudication - AI Validation >> Scenario 2: Rejected Specialty Drug Humira (Expected FAIL - Missing PA)
- Location: src\tests\claimValidation.spec.ts:135:7
...
Expected substring: "Prior Authorization"
Received string:    "Member does not have an active prior authorization approval on file for this specific National Drug Code (NDC)."
```
