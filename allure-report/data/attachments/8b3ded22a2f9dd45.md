...
Expected substring: "AWP"
Received string:    "Pricing calculation discrepancy in the adjudication engine. Check contract rate tables or discount formulas."
```

# Test source

```ts
  158 |     expect(aiResult.possibleRootCause?.toLowerCase()).toContain('prior authorization');
  159 |   });
  160 | 
