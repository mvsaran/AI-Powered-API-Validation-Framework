...
- Name: claimValidation.spec.ts >> Healthcare Member Eligibility - AI Validation >> Scenario 5: Terminated Member Eligibility Check (Expected FAIL)
- Location: src\tests\claimValidation.spec.ts:227:7
...
Expected substring: "terminated"
Received string:    "Member ineligibility due to inactive status"
```
